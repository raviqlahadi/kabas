...
class Wordtype extends Admin_Controller {

    private $name = null;
    private $parent_page = 'dictionary';
    private $current_page = 'dictionary/wordtype';
    ...
    public function index(){
        ...
        $pagination['total_records'] = (isset($key)) ? $this->m_wordtype->search_count($key, $this->name) : $this->m_wordtype->get_total();
        ...
        $for_table = $this->m_wordtype->fetch($fetch);
        ...
        $this->data["block_header"] = "Jenis Kata Manajemen";
        $this->data["header"] = "TABEL JENIS KATA";
        $this->data["sub_header"] = 'Klik Tombol Action Untuk Aksi Lebih Lanjut';
        //$data['wordtype'] = $this->m_wordtype->wordtype($this->session->wordtypedata('wordtype_id'));
        //$data['subwordtype'] = $this->m_wordtype->subwordtype($this->session->wordtypedata('wordtype_id'));

        $this->render( "dictionary/wordtype/content");
    }
    ...
    public function create(){
      ...
      $this->data["block_header"] = "Jenis Kata Manajemen";
      $this->data["header"] = "Tambah Jenis Kata";
      $this->data["sub_header"] = 'Tekan Tombol Simpan Ketika Selesai Mengisi Form';
      $this->render( "dictionary/wordtype/create");
    }

    public function insert($data) {
      $insert = $this->m_wordtype->add($data);
      return $insert;
    }
    ...
    public function edit($id=null){
      ...
      $w['id'] = $id;
      $form_value = $this->m_wordtype->getWhere($w);
      if($form_value==false){
        redirect($this->current_page);
      }else{
      ...
      $this->data['parent_page'] = $this->current_page;
      $this->data["block_header"] = "Jenis Kata Manajemen";
      $this->data["header"] = "Ubah Jenis Kata";
      $this->data["sub_header"] = 'Silahkan ubah data yang ingin anda ganti';
      $this->render( "dictionary/wordtype/edit");
    }

    public function update($id, $data) {
      $insert = $this->m_wordtype->update($id, $data);
      return $insert;
    }
    ...
    public function detail($id=null){
      ...
      $this->data["block_header"] = "Jenis Kata Manajemen";
      $this->data["header"] = "Detail Jenis Kata";
      $this->data["sub_header"] = 'Halaman Ini Hanya Berisi Informasi Detail Dari Data';
      $this->render("dictionary/wordtype/detail");
    }
    ...
    public function delete($id) {
      ...
      $w['id'] = $id;
      $delete = $this->m_wordtype->delete($w);
      if($delete!=false){
